    ...
    public partial class InitialContext : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "LH001", new DateTime(2024, 2, 10, 20, 9, 25, 174, DateTimeKind.Local).AddTicks(5288), (short)30, "Toán cao cấp", "Đang hoạt động" },
                    { "LH002", new DateTime(2024, 2, 20, 20, 9, 25, 174, DateTimeKind.Local).AddTicks(5303), (short)25, "Vật lý đại cương", "Đang hoạt động" },
                    { "LH003", new DateTime(2024, 3, 1, 20, 9, 25, 174, DateTimeKind.Local).AddTicks(5305), (short)20, "Hóa học cơ bản", "Đang hoạt động" },
                    { "LH004", new DateTime(2024, 3, 11, 20, 9, 25, 174, DateTimeKind.Local).AddTicks(5306), (short)35, "Lập trình C#", "Đang hoạt động" },
                    { "LH005", new DateTime(2024, 3, 21, 20, 9, 25, 174, DateTimeKind.Local).AddTicks(5308), (short)30, "Lập trình Java", "Đang hoạt động" },
                    { "LH006", new DateTime(2024, 3, 31, 20, 9, 25, 174, DateTimeKind.Local).AddTicks(5310), (short)25, "Lập trình Python", "Đang hoạt động" },
                    { "LH007", new DateTime(2024, 4, 10, 20, 9, 25, 174, DateTimeKind.Local).AddTicks(5311), (short)20, "Lập trình JavaScript", "Đang hoạt động" },
                    { "LH008", new DateTime(2024, 4, 20, 20, 9, 25, 174, DateTimeKind.Local).AddTicks(5312), (short)35, "Lập trình PHP", "Đang hoạt động" },
                    { "LH009", new DateTime(2024, 4, 30, 20, 9, 25, 174, DateTimeKind.Local).AddTicks(5313), (short)30, "Lập trình Ruby", "Đang hoạt động" },
                    { "LH010", new DateTime(2024, 5, 10, 20, 9, 25, 174, DateTimeKind.Local).AddTicks(5314), (short)25, "Lập trình Swift", "Đang hoạt động" }
                });
