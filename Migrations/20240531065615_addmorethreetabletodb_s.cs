...
{
    /// <inheritdoc />
    public partial class addmorethreetabletodb_s : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "LH001", new DateTime(2024, 2, 21, 13, 56, 14, 702, DateTimeKind.Local).AddTicks(4889), (short)30, "Toán cao cấp", "Đang Đang hoạt động" },
                    { "LH002", new DateTime(2024, 3, 2, 13, 56, 14, 702, DateTimeKind.Local).AddTicks(4904), (short)25, "Vật lý đại cương", "Đang Đang hoạt động" },
                    { "LH003", new DateTime(2024, 3, 12, 13, 56, 14, 702, DateTimeKind.Local).AddTicks(4905), (short)20, "Hóa học cơ bản", "Đang Đang hoạt động" },
                    { "LH004", new DateTime(2024, 3, 22, 13, 56, 14, 702, DateTimeKind.Local).AddTicks(4907), (short)35, "Lập trình C#", "Đang Đang hoạt động" },
                    { "LH005", new DateTime(2024, 4, 1, 13, 56, 14, 702, DateTimeKind.Local).AddTicks(4908), (short)30, "Lập trình Java", "Đang Đang hoạt động" },
                    { "LH006", new DateTime(2024, 4, 11, 13, 56, 14, 702, DateTimeKind.Local).AddTicks(4910), (short)25, "Lập trình Python", "Đang Đang hoạt động" },
                    { "LH007", new DateTime(2024, 4, 21, 13, 56, 14, 702, DateTimeKind.Local).AddTicks(4911), (short)20, "Lập trình JavaScript", "Đang Đang hoạt động" },
                    { "LH008", new DateTime(2024, 5, 1, 13, 56, 14, 702, DateTimeKind.Local).AddTicks(4912), (short)35, "Lập trình PHP", "Đang Đang hoạt động" },
                    { "LH009", new DateTime(2024, 5, 11, 13, 56, 14, 702, DateTimeKind.Local).AddTicks(4913), (short)30, "Lập trình Ruby", "Đang Đang hoạt động" },
                    { "LH010", new DateTime(2024, 5, 21, 13, 56, 14, 702, DateTimeKind.Local).AddTicks(4914), (short)25, "Lập trình Swift", "Đang Đang hoạt động" }
                });
